...
export default function ContactForm() {
  ...
  return (
    <section className="text-white w-full text-start">
      <form
        className="max-w-xs sm:max-w-sm md:max-w-3xl lg:max-w-5xl mx-auto"
        ref={form}
        onSubmit={sendEmail}
        id="formContact"
      >
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 w-full mb-5 group">
            ...
            />
            <svg
              className="w-4 h-4 peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              aria-hidden="true"
            ...
            <label
              ...
              className="pl-5 peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              Nombre
            </label>
          </div>
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label
              ...
              className="pl-6 peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              Email
            </label>
          </div>
        ...
        <div className="mb-5 justify-center md:justify-start items-center text-center md:text-start md:space-x-5 flex flex-col md:flex-row">
          ...
          >
            {CaptchaValue === true
              ? ''
              : 'Se tiene que realizar el reCAPTCHA para enviar el formulario'}
          </span>
        </div>
        <button
          type="submit"
          className="text-white bg-slate-950 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-slate-800  dark:hover:bg-slate-950 dark:focus:ring-blue-800"
        >
          Contactar
        </button>
      </form>
